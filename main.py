...
if __name__ == '__main__':
    ...
    ## MSRA
    # train_file = "data/NER_DATA/MSRA/MSRA_split.train"
    # dev_file = "data/NER_DATA/MSRA/MSRA_split.dev"
    # test_file = "data/NER_DATA/MSRA/MSRA.test"
    ## weibo
    train_file = "data/NER_DATA/Weibo/weiboNER.train"
    dev_file = "data/NER_DATA/Weibo/weiboNER.dev"
    test_file = "data/NER_DATA/Weibo/weiboNER.test"
    # train_file = "data/NER_DATA/Weibo/weiboNER_NE.train"
    # dev_file = "data/NER_DATA/Weibo/weiboNER_NE.dev"
    # test_file = "data/NER_DATA/Weibo/weiboNER_NE.test"
    ## OntoNote
    # train_file = "data/NER_DATA/OntoNotes/OntoNotes_split_BIO.train"
    # dev_file = "data/NER_DATA/OntoNotes/OntoNotes_split_BIO.dev"
    # test_file = "data/NER_DATA/OntoNotes/test.char.bio"
